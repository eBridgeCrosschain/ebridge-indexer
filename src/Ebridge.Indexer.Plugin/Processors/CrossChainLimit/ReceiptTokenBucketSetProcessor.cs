...
public class ReceiptTokenBucketSetProcessor : CrossChainLimitProcessorBase<ReceiptTokenBucketSet>
{
    public ReceiptTokenBucketSetProcessor(ILogger<ReceiptTokenBucketSetProcessor> logger,
    ...
    protected override async Task HandleEventAsync(ReceiptTokenBucketSet eventValue, LogEventContext context)
    {

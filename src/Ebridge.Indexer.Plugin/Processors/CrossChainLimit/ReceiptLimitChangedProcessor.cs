...
public class ReceiptLimitChangedProcessor : CrossChainLimitProcessorBase<ReceiptLimitChanged>
{
    public ReceiptLimitChangedProcessor(ILogger<ReceiptLimitChangedProcessor> logger,
    ...
    protected override async Task HandleEventAsync(ReceiptLimitChanged eventValue, LogEventContext context)
    { 

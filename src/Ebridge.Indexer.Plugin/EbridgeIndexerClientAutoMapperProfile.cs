...
public class EbridgeIndexerClientAutoMapperProfile : Profile
{
    public EbridgeIndexerClientAutoMapperProfile()
    {
        CreateMap<CrossChainLimitInfoIndex, CrossChainLimitInfoDto>();

        //CrossChainLimitInfo
        CreateMap<LogEventContext, CrossChainLimitInfoIndex>();

...
{
    public SwapDailyLimitSetProcessor(ILogger<SwapDailyLimitSetProcessor> logger,
    ...
    protected override async Task HandleEventAsync(SwapDailyLimitSet eventValue, LogEventContext context)
    {

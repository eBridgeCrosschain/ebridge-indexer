...
using Ebridge.Indexer.Orleans.TestBase;
...
namespace Ebridge.Indexer.Plugin.Tests;

[DependsOn(
    typeof(EbridgeIndexerOrleansTestBaseModule),
    typeof(EbridgeIndexerPluginModule),
    typeof(AbpAutoMapperModule),
    typeof(AbpAutofacModule),
    typeof(AElfIndexingElasticsearchModule))]
public class EbridgeIndexerPluginTestModule : AbpModule
{
    private string ClientId { get; } = "TestEbridgeClient";
    private string Version { get; } = "TestEbridgeVersion";
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpAutoMapperOptions>(options => { options.AddMaps<EbridgeIndexerPluginTestModule>(); });
        ...
        context.Services.Configure<IndexSettingOptions>(options =>
        {
            ...
            options.IndexPrefix = "EbridgeIndexer";
        });
    ...
    {
        var types = GetTypesAssignableFrom<IIndexBuild>(typeof(EbridgeIndexerPluginModule).Assembly);
